...
# Radio
if [ "$prjname" = "19161" ] || [ "$prjname" = "19706" ] || [ "$prjname" = "19795" ] || [ "$prjname" = "20607" ] || [ "$prjname" = "21619" ] || [ "$prjname" = "2161A" ] || [ "$prjname" = "2169A" ] || [ "$prjname" = "2169B" ]; then
...
elif [ "$prjname" = "19161" ]; then
    setprop persist.vendor.nfc.config_file_name "libnfc-nxp-19161.conf"
